...
class DataArguments:
    ...
    demon_method: Optional[str] = field(
        default="none",
        metadata={"help": "Which demonstration to use in testing: none, random, SimCSE, bert"}
    )
    shots_num: Optional[int] = field(
        default=0,
        metadata={"help": "Number of shots for few shots"}
    )
    attack: Optional[str] = field(
        default="none",
        metadata={"help": "badnet, addsent, style, syntactic"}
    )
